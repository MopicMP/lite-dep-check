...
> Lite check python dependencies for updates

[![PyPI version](https://badge.fury.io/py/lite-dep-check.svg)](https://pypi.org/project/lite-dep-check/)
...
```bash
pip install lite-dep-check
```

## Quick Start

```python
from lite_dep_check import check
...
from lite_dep_check import batch
